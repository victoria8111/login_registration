...
// CHECK IF EMAIL IS ALREADY REGISTERED
            ...
            if (mysqli_num_rows($check_email) > 0) {
                $error_message = "This Email Address is already registered. Please try with another email address.";
            } else {
...
// INSER USER INTO THE DATABASE
                ...
                if ($insert_user === TRUE) {
                    $success_message = "Congratulations you have successfully signed up.";
                } else {
...
// IF FIELDS ARE EMPTY
        $error_message = "Kindly fill in all the required field.";
    }
}
